...
import '../../theme/css/addLecture.css'
...
export default function AddLecture() {
  ...
  const columns = [
    ...
    },
    {
      ...
      key: "action",
      render: (text, record) => (
        <Button className="Add-button" onClick={() => handleEdit(record)} style={{ marginRight: 8 }}>
  ...
  return (
    <div>
      <Table className="custom-table" columns={columns} dataSource={filteredData} components={components} />
